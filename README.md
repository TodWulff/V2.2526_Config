...
>>> LOOK >>> Also, be advised that this set of configs requires manual installation of some components
on top of a fresh install of the host OS and Klipper/Moonraker/Mainsail:
...
~~As info (for my recollection more than anything) there were four Klippy files I had overtly edited to keep console noise to a minimum:~~

Now I'm making use of console filters, vs. changing the source code.  pfft.  IKR.  What an idiot I was... :)
