...
v4l2-ctl -d0 --set-ctrl=contrast=7				# (int)  min=0 max=15 step=1 default=8
v4l2-ctl -d0 --set-ctrl=saturation=3				# (int)  min=0 max=15 step=1 default=7
v4l2-ctl -d0 --set-ctrl=hue=4					# (int)  min=-10 max=10 step=1 default=0
v4l2-ctl -d0 --set-ctrl=white_balance_temperature_auto=1	# (bool) default=1
v4l2-ctl -d0 --set-ctrl=gamma=2				# (int)  min=1 max=10 step=1 default=10
...
v4l2-ctl -d0 --set-ctrl=backlight_compensation=0		# (int)  min=0 max=1 step=1 default=1 value=1
