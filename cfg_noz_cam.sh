v4l2-ctl -d2 --set-ctrl=brightness=8				# (int)  min=0 max=15 step=1 default=8#
v4l2-ctl -d2 --set-ctrl=contrast=7				# (int)  min=0 max=15 step=1 default=8
v4l2-ctl -d2 --set-ctrl=saturation=3				# (int)  min=0 max=15 step=1 default=7
v4l2-ctl -d2 --set-ctrl=hue=4					# (int)  min=-10 max=10 step=1 default=0
v4l2-ctl -d2 --set-ctrl=white_balance_temperature_auto=1	# (bool) default=1
v4l2-ctl -d2 --set-ctrl=gamma=10				# (int)  min=1 max=10 step=1 default=10
v4l2-ctl -d2 --set-ctrl=power_line_frequency=2			# (menu) min=0 max=2 default=2  0:Disabled 1:50Hz 2:60Hz
